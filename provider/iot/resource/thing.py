...
class THINGS(ResourceProvider):
    ...
    def get_resources(self) -> List[Resource]:
        ...
        for thing in self.iot_options.thing_name['things']:
            ...
            resources_found.append(Resource(digest=ResourceDigest(id=thing['thingName'],
                                                                    type='aws_iot_thing'),
            ...
            for thing_type in thing_types['thingTypes']:
                ...
                if "thingTypeName" in response:
                    if thing_type['thingTypeName'] == response['thingTypeName']:
                        ...
                        iot_type_digest = ResourceDigest(id=thing_type['thingTypeArn'],
                                                         type='aws_iot_type')
                        ...
                        self.relations_found.append(ResourceEdge(from_node=iot_type_digest,
            ...
            for job in jobs['jobs']:
                ...
                for target in data_job['job']['targets']:
                    ...
                    if thing['thingName'] in target:
                        ...
                        self.relations_found.append(ResourceEdge(from_node=iot_job_digest,
                                                                 to_node=ResourceDigest(id=thing['thingName'],
                                                                                        type='aws_iot_thing')))
            ...
            for billing_group in billing_groups['billingGroups']:
                ...
                if "billingGroupName" in response:
                    ...
                    if billing_group['groupName'] == response['billingGroupName']:
                        ...
                        iot_billing_group_digest = ResourceDigest(id=billing_group['groupArn'],
